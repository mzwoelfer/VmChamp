...
public class DistroInfo
{
  public static IEnumerable<DistroInfo> Distros { get; set; } = new List<DistroInfo>()
  {
    ...
    new()
    {
      Name = "Fedora41",
      Family = "Fedora",
      ImageName = "Fedora-Cloud-Base-Generic-41-1.4.x86_64.qcow2",
      Url = "https://download.fedoraproject.org/pub/fedora/linux/releases/41/Cloud/x86_64/images/",
      Aliases = Array.Empty<string>(),
      ChecksumFile = "Fedora-Cloud-41-1.4-x86_64-CHECKSUM",
      ChecksumType = "sha256"
    },
    new()
    {
    ...
    new()
    {
      Name = "Rocky10",
      Family = "RHEL",
      ImageName = "Rocky-10-GenericCloud-Base.latest.x86_64.qcow2",
